...
public class WeiboTemplate extends AbstractOAuth2ApiBinding implements Weibo {
    ...
    protected MappingJackson2HttpMessageConverter getJsonMessageConverter() {
        ...
        objectMapper.registerModules(new WeiboModule());
    ...
    protected FormHttpMessageConverter getFormMessageConverter() {
        FormHttpMessageConverter messageConverter = super.getFormMessageConverter();
        List<HttpMessageConverter<?>> partConverters = new ArrayList<HttpMessageConverter<?>>(3);
    ...
    private void initSubApis() {
        this.userOperations = new UserTemplate(objectMapper, getRestTemplate(), isAuthorized());
        this.accountOperations = new AccountTemplate(objectMapper, getRestTemplate(), isAuthorized());
        this.timelineOperations = new TimelineTemplate(objectMapper, getRestTemplate(), isAuthorized());
        this.friendOperations = new FriendTemplate(objectMapper, getRestTemplate(), isAuthorized());
        this.commentOperations = new CommentTemplate(objectMapper, getRestTemplate(), isAuthorized());
        this.favouriteOperations = new FavoriteTemplate(objectMapper, getRestTemplate(), isAuthorized());
        this.trendOperations = new TrendTemplate(objectMapper, getRestTemplate(), isAuthorized());
    }
